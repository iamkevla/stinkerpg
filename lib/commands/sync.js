...
module.exports = function *(argv) {
  ...
  let clientSource = new Client({host: sourceHost, port: sourcePort, user: sourceUser, password: sourcePassword});
  
  let clientTarget = new Client({host: targetHost, port: targetPort, user: targetUser, password: targetPassword});
  // get sourceTableList
